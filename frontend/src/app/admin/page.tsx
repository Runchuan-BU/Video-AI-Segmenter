...
export default function AdminPage() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-100 to-green-50 p-4">
      <RoleToolbar />
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-2xl text-center space-y-6">
        ...
        {/* TODO: Annotator section to be implemented later */}
        {/* <AnnotatorPanel /> */}

        {/* TODO: Audit log section */}
        {/* <AuditLog /> */}
